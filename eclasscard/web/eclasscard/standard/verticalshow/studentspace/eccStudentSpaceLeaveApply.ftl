<div id='vacate' class="tab-pane active">
	<ul class="leave-paper-type clearfix">
		<li class="active"><a href="javascript:void(0);" onclick="changeLeaveType(1,this)">请假单</a></li>
		<li><a href="javascript:void(0);" onclick="changeLeaveType(4,this)">长期通校申请单</a></li>
	</ul>
		...
		<table class="table table-leave">
			...
			<tbody>
				...
				<tr id="bed" style="display:none">
					<th class="cell-big" width="17%">床位是否保留：</th>
					<td width="83.33%" colspan="5">
...
function changeLeaveType(type,objthis) {
...
function saveLeave(){
	...
	var options = {
		...
		success : function(data){
	 		if(data.success){
				studentLeaveTab(1,leaveType,this);
	 		}else{
