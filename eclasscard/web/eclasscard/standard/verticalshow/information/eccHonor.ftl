		...
		<ul class="honor-list honor-list-h js-honor-slick">
			...
			<li class="honor-item">
				<div class="honor-photo-frame">
					...
					<#if item.style == 1>
					<img src="${request.contextPath}/static/eclasscard/standard/show/images/honor-flag.png" alt="">
					<#elseif item.style == 2>
					<img src="${request.contextPath}/static/eclasscard/standard/show/images/honor-cup.png" alt="">
					<#else>
					<img src="${request.contextPath}/static/eclasscard/standard/show/images/honor-medal.png" alt="">
					</#if>
					</div>
				</div>
