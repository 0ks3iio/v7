<div class="page-content">
	...
	<div class="navbar-fixed-bottom opt-bottom">
		<a class="btn btn-blue" href="#" onClick="printPDF('${testResult.studentId!}')">导出pdf</a>
		<a class="btn btn-white" href="#" onClick="onBatchPrint('${testResult.studentId!}')">打印</a>
	</div>
</div><!-- /.page-content -->
<script>
	$(function(){
		<#-- 返回 -->
		showBreadBack(goback,true,"评测记录");
	...
	function goback() {
		$("#showTestResultListDiv").attr("style","display:block");
		$("#showTestResultDiv").attr("style","display:none");
	}
</script>