...
<#list classSubjectList as css>
	<#list css as cs>
		<#if css_index !=0 || cs_index!=0>,</#if>"${cs.classId!}_${cs.subjectId!}":"${cs.noArrangeTime!}"
	</#list>
</#list>
</#if>
};
...
<script type="text/javascript" src="${request.contextPath}/basedata/scheduleModify/mutil/${indexId!}/myscript-array2"></script>
<#elseif type! == "T">
<#--<script type="text/javascript" src="${request.contextPath}/static/newgkelective/myscript-array-t.js"></script> -->
<script type="text/javascript" src="${request.contextPath}/basedata/scheduleModify/mutil/${indexId!}/myscript-array2?type=${type}"></script>
<#elseif type! == "P">
<script type="text/javascript" src="${request.contextPath}/basedata/scheduleModify/mutil/${indexId!}/myscript-array2?type=${type}"></script>
</#if>
<#--
