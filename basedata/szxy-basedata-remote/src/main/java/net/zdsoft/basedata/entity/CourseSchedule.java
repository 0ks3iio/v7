...
@Entity
@Table(name = "BASE_COURSE_SCHEDULE")
public class CourseSchedule extends BaseEntity<String> {

    private static final long serialVersionUID = 1L;
    
    public static final int CLASS_TYPE_NORMAL = 1; //行政班
    public static final int CLASS_TYPE_TEACH = 2; //教学班
//    public static final int CLASS_TYPE_SEVEN = 3; //7选3
    public static final int CLASS_TYPE_4 = 4; //选课班级类型
	...
	public static final int SUBJECT_TYPE_1=1;// 必修课
	public static final int SUBJECT_TYPE_2=2;//选修课
	public static final int SUBJECT_TYPE_3=3;// 虚拟课
	...
	private int weekType = WEEK_TYPE_NORMAL;//单周，双周，正常
