            ...
            <div class="box-body" style="">
                <table class="table table-bordered table-striped no-margin" style="table-layout:fixed;width: 100%">
                    ...
                    <tr>
                        ...
                        <td>学号</td>
                        <td colspan="2">${student.studentCode!}</td>
                        <td>性别</td>
                        <td colspan="2">${mcodeSetting.getMcode("DM-XB", (student.sex?string)?default("0"))}</td>
                        <td>班级</td>
                        <td colspan="2">${student.className!}</td>
                        <td colspan="2">最终总分</td>
                        <td colspan="2">${totalScore?string("0.##")}</td>
                        <td colspan="4"></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td <#if !isShow>colspan="4"</#if> rowspan="2">${xkjsScore?string("0.##")}</td>
                        <#if isShow>
                    ...
                    <tr>
                        ...
                        <td rowspan="2" colspan="2">${xkScore!}</td>
                        <td rowspan="2" colspan="13">${xkResult!}</td>
                    </tr>
                    <tr></tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td rowspan="16" colspan="2">${dyScore?string("0.##")}</td>
                    ...
                    <tr>
                        ...
                        <td rowspan="12" colspan="2">${dyScore?string("0.##")}</td>
                        </#if>
                    ...
                    <tr>
                        <td rowspan="2">体育</td>
                        <td rowspan="2" colspan="<#if isShow>2<#else>4</#if>">${tycj[0]!}</td>
                        <#if isShow>
                        <td rowspan="2" colspan="2">${acadyears[0]!}学年</td>
                        <td colspan="2">实分1</td>
                        <td>折分</td>
                        </#if>
                        <td rowspan="2" <#if !isShow>colspan="2"</#if>>${acadyears[1]!}学年</td>
                        <td>实分1</td>
                        <td>实分2</td>
                        <td>折分</td>
                        <td rowspan="2" <#if !isShow>colspan="2"</#if>>${acadyears[2]!}学年</td>
                        <td>实分1</td>
                        <td>实分2</td>
                        <td>折分</td>
                        <td rowspan="2" <#if !isShow>colspan="2"</#if>>${acadyears[3]!}学年</td>
                        <td colspan="2">实分1</td>
                        <td>折分</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td rowspan="24" colspan="2">${myScore?string("0.##")}</td>
