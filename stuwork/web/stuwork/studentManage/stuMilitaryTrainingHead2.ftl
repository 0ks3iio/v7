...
function getClassList() {
	...
	$.ajax({
		url: "${request.contextPath}/stuwork/militaryTraining/clsList",
	...
	var enter = $('#enter').val();
    var url = "${request.contextPath}/stuwork/militaryTraining/pageList?gradeId="+gradeId+"&enter="+enter;
    $("#showList").load(url);
}
...
function searchList(){
    ...
    var gradeId = $('#gradeId').val();
    var enter = $('#enter').val();
    var url = "${request.contextPath}/stuwork/militaryTraining/pageList?gradeId="+gradeId+"&classId=" + classId+"&enter="+enter;
    $("#showList").load(url);
}
</script>