...
public interface DyDormStatResultDao extends BaseJpaRepositoryDao<DyDormStatResult, String>{
	@Modifying
	...
	@Query("FROM DyDormStatResult WHERE schoolId = ?1  and acadyear= ?2 and semester= ?3 and week= ?4 ")
	public List<DyDormStatResult> findListByCon(String schoolId,String acadyear,String semester,int week);
}
