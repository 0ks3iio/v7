...
function showInterTypeList(){
  ...
  $(".table-container").load("${request.contextPath}/datacenter/examine/interface/type/showIntefaceTypes?typeName="+typeName+"&classify="+classify);
}
...
function saveInterfaceType(){
  ...
  $.ajax({
        url:"${request.contextPath}/datacenter/examine/interface/type/saveType",
...
function deleteType(){
	...
	function(){
		$.ajax({
            url:"${request.contextPath}/datacenter/examine/interface/type/delType?typeId="+typeid,
            data:{},
            dataType:'json',
            contentType:'application/json',
            type:'GET',
...
function editType (typeId){
	  ...
	  $('.layer-intertype-detailedId').load("${request.contextPath}/datacenter/examine/interface/type/editType?typeId="+typeId,function(){			
	  layer.open({
				type: 1,
				shade: .5,
				title: titleContent,
