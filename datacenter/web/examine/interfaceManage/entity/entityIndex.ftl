<a href="javascript:" onclick="showTab('3')" class="page-back-btn"><i class="fa fa-arrow-left"></i> 返回</a>
...
function showEntityList(){
	var url =  '${request.contextPath}/datacenter/examine/interface/entity/showEntityList?type='+'${type!}';
	$(".table-container").load(url);
}

//登记属性
$('.filter .js-checkIn').on('click', function(e){
	$('.layer-entity-detailedId').load("${request.contextPath}/datacenter/examine/interface/entity/editEntity?type="+'${type!}',function(){			
	layer.open({
				type: 1,
				shade: .5,
				title: '新增属性',
