...
function startEntity(){
  ...
  updateEntity("${request.contextPath}/datacenter/examine/interface/entity/isUsingEntity?entityId="+entityId+"&isUsing=1");
}  

function stopEntity(){
  var entityId = $(this).parents('tr').data('entityid');
  updateEntity("${request.contextPath}/datacenter/examine/interface/entity/isUsingEntity?entityId="+entityId+"&isUsing=0");
} 
...
$('.delete').on('click', function(e){
	...
	function(){
		$.ajax({
            url:"${request.contextPath}/datacenter/examine/interface/entity/delEntity?entityId="+entityId,
            data:{},
            dataType:'json',
            contentType:'application/json',
            type:'GET',
...
$('.modify').on('click', function(e){
	var entityId = $(this).parents('tr').data('entityid');
	$('.layer-entity-detailedId').load("${request.contextPath}/datacenter/examine/interface/entity/editEntity?entityId="+entityId,function(){			
	layer.open({
				type: 1,
				shade: .5,
				title: '修改属性',
				...
				yes:function(index,layero){
				   saveEntity("${request.contextPath}/datacenter/examine/interface/entity/saveEntity");
	            },
