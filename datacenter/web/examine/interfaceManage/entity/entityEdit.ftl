<div class="layer-content">
	<div class="form-horizontal">
		...
		<div class="form-group">
			<label class="col-sm-3 control-label no-padding-right">数据库字段长度：</label>
			<div class="col-sm-9" >
			  <input type="text" nullable="false" maxLength="50" id="entityLength" class="form-control" 
		...
		<div class="form-group">
			<label class="col-sm-3 control-label no-padding-right">子段类型：</label>
			<div class="col-sm-9" >
			  <input type="text"  nullable="false" maxLength="50" id="columnProp" class="form-control" 
			  <#if entity?exists> value="${entity.columnProp!}" </#if> />
			</div>
		</div>
		<div class="form-group"> 
			<label class="col-sm-3 control-label no-padding-right">是否有默认值：</label>
			<div class="col-sm-9" id= "isDefault">
			  <#if entity?exists>
