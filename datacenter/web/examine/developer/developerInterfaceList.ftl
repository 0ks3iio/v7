...
function modifyLimit(type){
      ...
      $('.layer-sensitive').load("${request.contextPath}/datacenter/examine/developer/editInterfaceLimit?ticketKey="+ticketKey + "&type=" + type,function(){			
		layer.open({
					type: 1,
					shade: .5,
					title: '修改限制条件',
					...
					yes:function(index,layero){
					   saveParam("${request.contextPath}/datacenter/examine/developer/saveInterfaceLimit");
		            },
