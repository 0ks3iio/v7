 ...
 */
public interface OpenApiEntityTicketService extends BaseService<OpenApiEntityTicket, String>{
    /**
     * 查询用户可接口可获得的敏感字段
     * 
     * @author chicb
     ...
     * @return
     */
    List<OpenApiEntityTicket> getEntitys(String ticketKey, int isSenitive, String... types);
