...
public class BaseUrlUtils {
	...
	private static String getUrl(OpenApiPushJob job){
		String url;
	...
	public static String getUrl(OpenApiPushJob job, Integer page){
	...
	public static String getPushUrl(OpenApiPushJob pushJob) {
