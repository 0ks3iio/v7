...
<div id="cc" class="tab-pane active" role="tabpanel">
	...
	<h1 class="text-center"><span class="mr150">考区：${regionName!}</span><span class="mr150">考点：${emOptionName!}</span><span>考场：${placeName!}</span></h1>
...
<script>
	...
	function goSearch(regionId,optionId,placeId){
		...
		var url ='${request.contextPath}/exammanage/edu/examReports/detailList/page?examId='+examId+"&regionId="+regionId+"&optionId="+optionId+"&placeId="+placeId+"&regionPick="+regionPick+"&optionPick="+optionPick+"&type=1"+"&numPick="+numPick;
		$("#showTabDiv").load(url);
	}
