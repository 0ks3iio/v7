...
<div class="box box-default">
  	<div class="box-header">
	 	<h4 class="box-title">科目设置(${examInfo.examName!})</h4>
						...
						<div class="widget-main padding-12">
							...
							<div class="filter">
								...
								<div class="filter-item">
									<div class="filter-content">
									    <div class="input-group">
											<input class="form-control date-picker startDateClass" vtype="data"  type="text" nullable="false" name="emSubjectInfoList[${item_index}].strStartDate" id="strStartDate_${item_index}" placeholder="考试开始时间(到分钟)" value="${(item.startDate?string('yyyy-MM-dd HH:mm'))!}">
								...
								<div class="filter-item">
									<div class="filter-content">
									    <div class="input-group">
											<input class="form-control date-picker endDateClass" vtype="data"  type="text" nullable="false" name="emSubjectInfoList[${item_index}].StrEndDate" id="StrEndDate_${item_index}" placeholder="考试结束时间(到分钟)" value="${(item.endDate?string('yyyy-MM-dd HH:mm'))!}">
											<span class="input-group-addon">
												<i class="fa fa-calendar bigger-110"></i>
											</span>
									    </div>
			...
			<div class="widget-main padding-12">
				...
				<div class="filter">
					...
					<div class="filter-item">
						<div class="filter-content">
						    <div class="input-group">
								<input class="form-control date-picker startDateClass" vtype="data"  type="text" nullable="false" name="strStartDate" id="strStartDate" placeholder="考试开始时间(到分钟)" value="">
								<span class="input-group-addon">
									<i class="fa fa-calendar bigger-110"></i>
								</span>
						    </div>
					...
					<div class="filter-item">
						<div class="filter-content">
						    <div class="input-group">
								<input class="form-control date-picker endDateClass" vtype="data" type="text" nullable="false" name="StrEndDate" id="StrEndDate" placeholder="考试结束时间(到分钟)" value="">
								<span class="input-group-addon">
									<i class="fa fa-calendar bigger-110"></i>
								</span>
						    </div>
...
$(function(){
	...
	$('.gotoExamListClass').on('click',function(){
		var url =  '${request.contextPath}/exammanage/edu/examInfo/index/page';
