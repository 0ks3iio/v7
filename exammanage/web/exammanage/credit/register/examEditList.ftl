...
function onSubClick(subId) {
    ...
    var url =  '${request.contextPath}/exammanage/credit/register/exam?acadyear='+acadyear+'&semester='+ semester+'&gradeId='+gradeId+'&subjectId='+subId;
...
function onClsClick(clsTypeId) {
    if(clsTypeId==""){
        ...
        var acadyear=$("#acadyear").val();
		var semester=$("#semester").val();
		$("#clsTypeId").attr('value',clsTypeId);
        var url = '${request.contextPath}/exammanage/credit/register/exam/page?subjectId=' + subjectId + '&clsTypeId=' + clsTypeId+ '&acadyear=' + acadyear+ '&semester=' + semester;
...
function onClsClick(clsTypeId) {
    var acadyear=$("#acadyear").val();
	var semester=$("#semester").val();
    var url = '${request.contextPath}/exammanage/credit/register/exam?clsTypeId=' + clsTypeId+ '&acadyear=' + acadyear+ '&semester=' + semester;
    $("#editDiv").load(url,function () {
        $(".clsList").each(function () {
            $(this).removeClass("selected")
        });
...
function onSubClick(subId) {
    if(subId==""){
		...
		$("#subjectId").attr('value',subId);
	    var url =  '${request.contextPath}/exammanage/credit/register/exam/page?acadyear='+acadyear+'&semester='+ semester+'&clsTypeId='+clsTypeId+'&subjectId='+subId;
        $("#listDiv").load(url,function () {
            $(".subList").each(function () {
	            $(this).removeClass("selected")
	        });
