...
function changeAS(){
	...
	var url = '${request.contextPath}/exammanage/scoreOptional/index/page?acadyearSearch='+acadyearSearch+'&semesterSearch='+semesterSearch+'&noLimit=${noLimit!}';
	$('#myTestDiv').load(url);
}
function updateClass(){
	...
	var url = '${request.contextPath}/exammanage/scoreOptional/updateClass';
...
function searchList(){
	...
	if(classIdSearch == ''){
		$(".tabDiv").html('<div class="no-data-container"><div class="no-data"><span class="no-data-img"><img src="${request.contextPath}/static/images/public/nodata6.png" alt=""></span><div class="no-data-body"><p class="no-data-txt">暂无记录</p></div></div></div>');
		return;
	}
	var url = '${request.contextPath}/exammanage/scoreOptional/tablist';
...
function searchImport(){
	...
	var url='${request.contextPath}/exammanage/scoreOptional/import/index'+str;
	url=encodeURI(encodeURI(url));
	$(".tabDiv").load(url);
}
function gobackIndex(){
	var url='${request.contextPath}/exammanage/scoreOptional/index/page';
	$(".model-div").load(url);
}
</script>