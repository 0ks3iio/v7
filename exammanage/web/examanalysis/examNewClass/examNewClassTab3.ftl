    ...
    <div class="box-body">
        <div class="filter box-graybg mb10 no-padding-bottom">
            ...
            <div class="filter-item">
                ...
                <div class="filter-content">
                    <select vtype="selectOne" class="form-control" id="examId" onChange="showClassList()">
            ...
            <div class="filter-item">
                ...
                <div class="filter-content">
                    <select class="form-control" id="classId" onChange="searchList()">
                        <option value="">---请选择---</option>
                    </select>
                </div>
            </div>
...
<script>
    ...
    function searchCompareExam() {
        ...
        $.ajax({
            ...
            data:{acadyear:acadyear,examId:examId,semester:semester,gradeCode:gradeCode,unitId:'${unitId!}',type:"11"},
            dataType: "json",
            success: function(data){
                var infolist=data.infolist;
                compareExamId.html("");
    ...
    function searchList(){
        ...
        var c2='?examId='+examId+'&acadyear='+acadyear+'&semester='+semester+'&gradeCode='
            +gradeCode+"&classId="+classId+"&type="+type+"&reportType="+reportType+"&compareExamId="+compareExamId;
        var url='${request.contextPath}/examanalysis/examNewClass/showClassData6/page'+c2;
