    ...
    <div class="box-body">
        <div class="filter box-graybg mb10 no-padding-bottom">
            ...
            <div class="filter-item">
                ...
                <div class="filter-content">
                    <select vtype="selectOne" class="form-control" id="examId" onChange="searchCompareExam()">
...
<script>
    ...
    function searchList(){
        ...
        var url='${request.contextPath}/examanalysis/examNewClass/showClassData7/page'+c2;
