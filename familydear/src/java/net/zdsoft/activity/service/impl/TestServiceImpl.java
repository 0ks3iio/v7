...
import net.zdsoft.activity.dao.TestDao;
 ...
 */
@Service("testService")
public class TestServiceImpl extends BaseServiceImpl<FamDearAttachment,String> implements TestService {
    @Autowired
    ...
    private void saveAttachmentWithBytes(FamDearAttachment att, byte[] bts){
...
//		dir.setDir("D://store");
    ...
    public List<FamDearAttachment> getAttachmentByObjId(String objId, String objType) {
        return testDao.getAttachmentByObjId(objId, objType);
    }
