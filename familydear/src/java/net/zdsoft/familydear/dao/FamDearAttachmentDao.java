 ...
 * @Version: 1.0
 */
public interface FamDearAttachmentDao extends BaseJpaRepositoryDao<FamDearAttachment, String> {
    @Query("from FamDearAttachment where objId=?1 and objecttype=?2 and isDelete='0' order by creationTime")
