                   ...
                   <div class="box-body" id="id2" >
                       <div class="filter clearfix" style="padding-left: 20px;">
                           ...
                           <#--<div class="filter-item">-->
                               ...
                               <#--</div>-->
                           <#--</div>-->
                           <a href="javascript:" class="btn btn-blue pull-left btn-seach" onclick="addExam()">新增</a>
                       </div>
...
//	});
	...
	<#--function changeClass(){-->
		...
		<#--var stuId=$("#stuId");-->
		<#--$.ajax({-->
			<#--url:"${request.contextPath}/studevelop/honorRecord/stuIds",-->
	...
	function honorList(){
		...
		var url='${request.contextPath}/studevelop/honorRecord/listAll'+ass;
		$(".showList").load(url);
	}
	...
	function changeStuId(){
		...
		var url='${request.contextPath}/studevelop/honorRecord/list'+ass;
		$(".showList").load(url);
	}  
	...
	function addExam(){
		...
		var ass = '?acadyear='+acadyear+'&semester='+semester+'&stuId='+stuId;
		var url='${request.contextPath}/studevelop/honorRecord/add'+ass;
		indexDiv = layerDivUrl(url,{title: "新增",width:750,height:650});
	}
$(function(){
