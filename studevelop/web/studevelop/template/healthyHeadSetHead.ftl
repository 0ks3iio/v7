                        ...
                        <#if  projectTyps?exists && (projectTyps?size gt 0)>
                            <#list projectTyps as projectType>
                                <li role="presentation" <#if projectType_index == 0> class="active" </#if> >
                                    <a href="javascript:void(0)"   role="tab" val="${projectType.thisId!}" onclick="itemList('${projectType.thisId!}');" data-toggle="tab">${projectType.mcodeContent!}</a>
                                </li>
                            </#list>
                        </#if>
                        </ul>
                        <div id="aa" class="tab-pane active" role="tabpanel">
                            <div class="table-container">
                                <div class="table-container-header text-right">
                                    <button type="button" class="btn btn-blue js-addScoreItem" onclick="editLink('')">添加身心项目</button>
...
<script>
    ...
    function getParamter(){
        ...
        var objectType = code + healthType;
