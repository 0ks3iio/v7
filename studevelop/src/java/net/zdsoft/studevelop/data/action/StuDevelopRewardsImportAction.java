...
public class StuDevelopRewardsImportAction extends DataImportAction{
	private Logger logger = Logger.getLogger(StuDevelopRewardsImportAction.class);
	@Autowired
	...
	@RequestMapping("/stuDevelopRewards/import/main")
	public String execute(ModelMap map,String acadyear,String semester, String classId) {
		// 业务名称
		map.put("businessName", "奖励信息");
		// 导入URL 
		map.put("businessUrl", "/studevelop/stuDevelopRewards/import");
		// 导入模板
		//String searchDateStr=DateUtils.date2String(searchDate,"yyyy-MM-dd");
		map.put("templateDownloadUrl", "/studevelop/stuDevelopRewards/template?acadyear="+acadyear+"&semester="+semester+"&classId="+classId);
		// 导入对象
		...
		return "/studevelop/record/stuDevelopRewardsImport.ftl";
	}

	@Override
	public String getObjectName() {
		return "stuDevelopRewardsImport";
	}
	...
	@Override
	@RequestMapping("/stuDevelopRewards/import")
	@ResponseBody
	public String dataImport(String filePath, String params) {
		...
		String jsonMsg = stuDevelopRewardsService.doImport(getLoginInfo().getUnitId(), datas, acadyear, semester);
		logger.info("导入结束......");
		return jsonMsg;
	}

	@Override
	@RequestMapping("/stuDevelopRewards/template")
	...
	public Map<String, String[]> getColMcodeMap(){
		...
		String[] mcodes = {"DM-JLJB","DM-XSHJLB"};
		...
		String[] cols = {"奖励级别", "奖励类别"};
		String[] colm = {"DM-JLJB","DM-XSHJLB"};
