            ...
            <div class="box-body app-form-box">
                <form class="form-horizontal margin-10" role="form" method="post" id="appForm"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <button class="btn btn-blue" type="button" id="app-save">保存</button>
...
<script>
    ...
    Event.prototype = {
        modifyApp: function () {
            ...
            var $this = this;
            $.ajax({
                url: '${request.contextPath}/bigdata/api/developer/front/app/save',
                type: 'POST',
                contentType: false,
                processData: false,
    ...
    $(function () {
        ...
        $('input.appTypes').on('change', function () {
            Validator.validateAppTypes();
        });
