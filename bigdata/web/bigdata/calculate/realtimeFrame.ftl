        <div class="flow-calculation wrap-full">
            <div class="box-directory">
                <dl>
                    <dt><b>菜单</b></dt>
                    <dd onclick="loadData('overview')"><span>概览</span> <i class="iconfont icon-dashboard"></i></dd>
                    <dd onclick="loadData('running-jobs')"><span>运行中的job</span> <i class="iconfont icon-run"></i></dd>
                    <dd onclick="loadData('completed-jobs')"><span>已完成的job</span> <i class="iconfont icon-successful font-14 "></i></dd>
                    <dd onclick="loadData('submit')"><span>上传的job</span> <i class="iconfont icon-upload"></i></dd>
                </dl>
            </div>

            <div class="box-content scrollBar4" id="flink-div">
            </div>
        </div>
...
<script type="text/javascript">
    ...
    function loadData(type){
        if(type == "submit"){
            ...
            var url =  "${request.contextPath}/bigdata/calculate/realtime/overview";
            $("#flink-div").load(url);
        }else if (type == "completed-jobs") {
            var url =  "${request.contextPath}/bigdata/calculate/realtime/jobs?type=completed-jobs";
            $("#flink-div").load(url);
        }else if (type == "running-jobs") {
    ...
    //目录
    $('.box-directory dd').on('click',function(){
