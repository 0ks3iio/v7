		    	...
		    	<tr>
			        <td>${report.name!}</td>
			         ...
			         <td>
			               ...
			               <!--<a href="javascript:void(0)">授权</a><span class="tables-line">|</span>-->
...
<script>
    function designMultiReport(id,type) {
    	...
    	if('7'==type)
    		titleName="报告设计";
    	router.go({
	        path: '/bigdata/multireport/design?type='+type+'&reportId='+ id,
	        name: titleName,
	        level: 2
	    }, function () {
	    	var url = '${request.contextPath}/bigdata/multireport/design?type='+type+'&reportId='+ id;
