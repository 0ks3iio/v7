<style type="text/css">
 ...
 <div class="box box-default box-face js-height">
	...
	<div class="map-right-part-wrap clearfix" >
		...
		<div class="wrap-1of1 slimScrollBar-made"  id="regionDetailId"></div>
	</div>
</div>
<script type="text/javascript">
    ...
    function initialize() {  
		// 百度地图API功能
		 map = new BMap.Map("allmap",{
			minZoom : ${currentRegion.zoomLevel!},
			maxZoom : ${currentRegion.zoomLevel!}+1
		});    // 创建Map实例
		...
		$("#regionDetailId").load("${request.contextPath}/bigdata/customization/xinjiang/common/gis/regionDetail?regionCode=${regionCode!}",function() {
	     ...
	     // marker.setAnimation(BMAP_ANIMATION_BOUNCE); //跳动的动画
          ...
          (function(){
    			...
    			_marker.addEventListener("mouseover",function(){
	    				$("#regionDetailId").load("${request.contextPath}/bigdata/customization/xinjiang/common/gis/regionDetail?regionCode="+_marker.fullCode,function() {
    			...
    			_marker.addEventListener("mouseout",function () {
				 ...
				 _marker.addEventListener("click",function (e) {
					if(_marker.fullCode.endWith("00")){
						$(".page-content").load("${request.contextPath}/bigdata/customization/xinjiang/common/gis/drill?regionCode="+_marker.fullCode+"&parentRegionCode="+parentRegionCode);
					}else{
                        showSchool(_marker.fullCode,parentRegionCode);
	...
	function return2Upper(){
		$(".page-content").load("${request.contextPath}/bigdata/customization/xinjiang/common/gis/drill?regionCode="+parentRegionCode);
	}
