(function (root) {
     ...
     * @param diagramId
     */
    dataV.deleteDiagram = function (screenId, diagramId, call) {
        $.ajax({
    ...
    dataV.doCancelActiveInteraction = function (elementId, callForSuccess) {
        $.ajax({
            url: _contextPath + '/bigdata/datav/diagram/config/interaction/' + elementId + '/active?screenId=' + _screenId,
            type: 'GET',
            success: function (res) {
                if (res.success) {
                    if (callForSuccess) {
    ...
    dataV.doGetRegionCodeByName = function (name, callBack) {
        $.ajax({
            url: _contextPath + '/bigdata/datav/region/convert/region',
            data: {
                name: name
            },
            type: 'post',
    ...
    dataV.modifyLevel = function (diagramId, top, call) {
        $.get(_contextPath + '/bigdata/datav/diagram/config/' + _screenId + "/modify-level",
            {diagramId: diagramId, top: top},
            function (res) {
                if (!res.success) {
                    netUtils.error(res.message);
                } else {
    ...
    dataV.upDownLevel = function(diagramId, up, call) {
        $.get(_contextPath + '/bigdata/datav/diagram/config/' + _screenId + "/up-down-level",
            {diagramId: diagramId, up: up},
            function (res) {
                if (!res.success) {
                    netUtils.error(res.message);
                } else {
    ...
    dataV.lockDiagram = function(diagramId, lock, call) {
        $.post(_contextPath + '/bigdata/datav/diagram/config/' + _screenId + "/lock",
            {diagramId: diagramId, lock: lock},
            function (res) {
                if (!res.success) {
                    netUtils.error(res.message);
                } else {
