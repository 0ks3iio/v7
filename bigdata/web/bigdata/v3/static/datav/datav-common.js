...
(function (root) {
    ...
    $('body').on('click', '.element-item', function () {
        let name = $(this).text();
        //修正多选时的问题
        let diagramId = $('.diagram-config-manager').attr('data-diagramid'); //$('div.box-data.choose').attr('data-index');
    ...
    function chooseSlideImg() {
        ...
        dataVRender.doRender({diagramId: $('.box-data.choose').data('index'), screenId: _screenId, dispose: false});
    }
