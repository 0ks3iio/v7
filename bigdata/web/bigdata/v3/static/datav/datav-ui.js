(function (root) {
    ...
    UI.addDiagram = function (diagram, call) {
        ...
        try {
            ...
            dataConfig.onChangePointerAndLine(boxXY.x, boxXY.y, $target[0])
        } catch (e) {
            console.log("net error" + e);
        }
    ...
    UI.deleteDiagram = function (screenId, diagramId, call) {
        dataVNet.deleteDiagram(screenId, diagramId, function () {
            try {
                UI.hideConfigPanel();
    ...
    UI.hideConfigPanel = function () {
        ...
        $('.left-part dd.active').removeClass('active');
    ...
    UI.loadLayer = function() {
        $('#layer-container').load(_contextPath + "/bigdata/datav/screen/"+ _screenId + "/layer");
    };
    ...
    diagramUtils.createBoxOfBody = function (diagramId, style) {
        ...
        // }
        box += '<span class="pointer">'+style.x + ',' + style.y +'</span>';
        box += '<span class="line-x" style="width: '+style.x+'px"></span>';
        box += '<span class="line-y" style="height:'+style.y+'px"></span>';
        ...
        new ZResize({
            ...
            mouseupCall: function (data) {
                ...
                if (changeXY(this.lastData, data)) {
                    ...
                    dataConfig.onChangePointerAndLine(data.left, data.top, data.el[0]);
                }
