            ...
            <div class="clearfix margin-b-20">
                <div class="col-md-4 no-padding-left">
                    ...
                    <div class="box-default no-padding-left radius-5 js-height-standard">
                        <div class="box-name">
                            <p class="no-margin radius-top-5">学段</p>
                        </div>
            ...
            <div class="clearfix margin-b-20">
                ...
                <div class="col-md-8 no-padding-right radius-5">
                    <div class="box-default no-padding-right radius-5 js-height-standard">
                        <div class="box-name">
                            <p class="no-margin radius-top-5">民族</p>
                        </div>
                        <div class="box-step radius-bottom-5">
...
<script type="text/javascript">
    ...
    function initSchoolSection() {
        $.ajax({
            url: '${request.contextPath}/bigdata/groupAnalysis/student/getSchoolSectionOption',
            data: {profileCode : $('#profileCode').val(), tagArray : $('#tagArray').val()},
            type: 'POST',
            dataType: 'json',
            success: function (response) {
    ...
    function initAge() {
        $.ajax({
            url: '${request.contextPath}/bigdata/groupAnalysis/student/getAge',
            data: {profileCode : $('#profileCode').val(), tagArray : $('#tagArray').val()},
            type: 'POST',
            dataType: 'json',
            success: function (response) {
    ...
    function initNation() {
        $.ajax({
            url: '${request.contextPath}/bigdata/groupAnalysis/student/getNationOption',
            data: {profileCode : $('#profileCode').val(), tagArray : $('#tagArray').val()},
            type: 'POST',
            dataType: 'json',
            success: function (response) {
