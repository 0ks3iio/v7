...
import net.zdsoft.api.openapi.pushjob.entity.ApiPushLogger;
import net.zdsoft.api.openapi.pushjob.service.ApiPushJobService;
import net.zdsoft.api.openapi.pushjob.utils.BaseUrlUtils;
...
public class ApiJobTask implements BaseJobTask{
	private  final Logger log = Logger.getLogger(ApiJobTask.class);
	
	ApiPushJobService basePushJobService = Evn.getBean("basePushJobService");
	private static RestTemplate restTemplate = new RestTemplate();
	
	@Override
	public void excute(String jobGroup, String jobName) {
		//jobGroup=ticketKey;jobName=BasePushJob.id
		ApiPushJob pushJob = basePushJobService.findOne(jobName);
		ApiPushLogger pushLogger = new ApiPushLogger();
