...
import net.zdsoft.api.base.dao.ApiBaseRelationDao;
...
@Service("apiBaseRelationService")
public class ApiBaseRelationServiceImpl extends BaseServiceImpl<BaseRelation, String> implements ApiBaseRelationService {
	public static final String BASE_RELATION_SERVICE_CACHE_HEAD = "base.relation.cache.head.";
	@Autowired
	private ApiBaseRelationDao baseRelationDao;
	@Override
