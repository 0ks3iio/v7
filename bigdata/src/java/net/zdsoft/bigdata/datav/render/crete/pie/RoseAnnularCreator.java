...
/**
 * @author shenke
 * @since 2018/10/10 15:27
 */
public class RoseAnnularCreator extends AbstractRoseCreator implements RenderOptionCreator<EChartsRenderOption> {
    ...
    public EChartsRenderOption create(Result result, Diagram diagram, List<EarlyParameter> earlyParameters) throws EntryUtils.DataException {
        if (!DiagramEnum.COMMON_PIE_ANNULAR_ROSE.getType().equals(diagram.getDiagramType())) {
            return null;
        }
