 ...
 * 散点图
 * @author shenke
 * @since 2018/10/10 16:32
 */
public class ScatterCreator extends AbstractScatterCreator implements RenderOptionCreator<EChartsRenderOption> {
    ...
    public EChartsRenderOption create(Result result, Diagram diagram, List<EarlyParameter> earlyParameters) throws EntryUtils.DataException {
        if (!DiagramEnum.SCATTER.getType().equals(diagram.getDiagramType())) {
            return null;
        }
