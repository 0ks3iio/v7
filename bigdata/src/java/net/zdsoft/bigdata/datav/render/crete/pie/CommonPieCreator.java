 ...
 * 基本饼状图Creator
 * @author shenke
 * @since 2018/10/10 14:27
 */
public class CommonPieCreator extends AbstractPieCreator implements RenderOptionCreator<EChartsRenderOption> {
    ...
    public EChartsRenderOption create(Result result, Diagram diagram, List<EarlyParameter> earlyParameters) throws EntryUtils.DataException {
        if (!DiagramEnum.COMMON_PIE.getType().equals(diagram.getDiagramType())) {
            return null;
        }
