...
/**
 * @author shenke
 * @since 2018/7/26 下午12:01
 */
public class OptionExposeScatter extends OptionExposeCartesian2dBase {


    public static OptionExposeScatter getDefaultOptionExpose() {
        OptionExposeScatter default_oe = new OptionExposeScatter();
