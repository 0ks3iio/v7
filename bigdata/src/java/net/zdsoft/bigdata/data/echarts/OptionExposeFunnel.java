...
/**
 * @author shenke
 * @since 2018/7/30 下午2:14
 */
public class OptionExposeFunnel {
    ...
    public static OptionExposeFunnel getDefaultExpose() {
        OptionExposeFunnel default_oe = new OptionExposeFunnel();
