...
<table class="table table-bordered table-striped js-sort-table show-stulist-table right-table">
	<thead>
		<tr>
			<th class="first_td">
	...
	<tbody>
		...
		<#list rightStuDtoList as item>
			<tr>
				<td class="first_td">
					<label class="pos-rel" style="margin-right: 0px">
						<input type="checkbox" class="wp" name="studentId"  value="${item.studentId!}">
						<span class="lbl"></span>
					</label>
				</td>
