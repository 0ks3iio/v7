...
public class CalculateSections {
	...
	public static void main(String[] args) {
		/*for (int i = 0; i < 1000; i ++) {
			List<Integer> r = calculateSectioning3A(i, 50, 5);
			System.out.println(i + ":"+r.size()+":" + r);
		}*/
		
		List<Integer> calculateSectioning = calculateSectioning(1397, 57, 3);
		System.out.println(calculateSectioning);
	}
...
//	public static List<Integer> calculateSectioning3A(int total, int max, int margin) {
//		assert max > 0;
//		assert max > margin;
//		assert total >= 0;
//		
//		List<Integer> sectionSizeList = new ArrayList<Integer>();
//		if (total < max) return sectionSizeList;
//			
//		int sectionCount = total / max;
//		int sectionSize = max;
//		if (sectionCount * margin >= total % max) {
//			sectionSize += (total % max) / sectionCount;
//		}
//		
//		int remainStudentCount = total;
//		while(remainStudentCount >= sectionSize) {
...
//		}
//		
//		System.out.println("remainStudentCount = " + remainStudentCount + " sectionSizeList.size() = " + sectionSizeList.size());
//		//assert remainStudentCount < sectionSizeList.size();
//		
//		//clean up the rest few
//		if (remainStudentCount > 0) {
