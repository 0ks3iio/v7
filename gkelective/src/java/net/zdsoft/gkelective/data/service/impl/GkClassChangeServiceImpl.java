...
//					linList = rightStudentTeachClassMap.get(string);
...
//					linList = leftStudentTeachClassMap.get(string);
...
//			List<TeachClass> teaClslist = SUtils.dt(teachClassRemoteService.findListByIds(allTeachClassIds.toArray(new String[0])), new TR<List<TeachClass>>(){});
...
//				teachClassStuRemoteService.saveAll(SUtils.s(saveList));
//			}
...
//			System.out.println(teachClass.getName()+"总分:"+dou);
	...
	public void saveStuSubChange(String unitId, String arrangeId, String roundId, String stuId, String searchClassType, String chosenClassIds, String searchSubjectIds) {
		...
		if("1".equals(searchClassType)){
			...
			gkGroupClassStuService.deleteStu(new String[]{chosenClassIds},new String[]{stuId});
