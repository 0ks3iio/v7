...
public interface GkResultDao extends BaseJpaRepositoryDao<GkResult, String> {
    ...
    @Query("select t1 from GkResult t1,Student t2 where t1.studentId=t2.id and t1.studentId in (?1) and t1.subjectArrangeId = ?2 order by t2.classId,t1.studentId,t1.subjectId")
