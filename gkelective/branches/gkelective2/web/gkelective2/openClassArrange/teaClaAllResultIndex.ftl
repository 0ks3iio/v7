...
<div class="box-body">
	<div class="nav-tabs-wrap">
		<ul class="nav nav-tabs nav-tabs-1" role="tablist">
			<li role="presentation" class="active"><a href="#ee" role="tab" id="ee" data-toggle="tab" onclick="itemShowList(5)">走班班级统计</a></li>
			<li role="presentation"><a href="#aa" role="tab" id="aa" data-toggle="tab" onclick="itemShowList(1)">走班班级详细</a></li>
			<li role="presentation"><a href="#bb" role="tab" id="bb" data-toggle="tab" onclick="itemShowList(2)">学生走班结果</a></li>
