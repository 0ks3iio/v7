...
public class GkTimetableLimitArrangServiceImpl extends BaseServiceImpl<GkTimetableLimitArrang, String> implements GkTimetableLimitArrangService {
    ...
    @Override
    public List<GkTimetableLimitArrang> findGkTimetableLimitArrangList(String unitId, String acadyear,
            String semester, String limitId, String limitType) {
        return gkTimetableLimitArrangDao.findGkTimetableLimitArrangList(unitId, acadyear, semester, limitId, limitType);
    }
    ...
    @Override
    public List<GkTimetableLimitArrang> findGkTimetableLimitArrangListBylimitIdIn(String unitId, String acadyear,
            String semester, String limitType, String arrangId, String[] limitIds) {
        return gkTimetableLimitArrangDao.findGkTimetableLimitArrangListBylimitIdIn(unitId, acadyear, semester,
                limitType, arrangId, limitIds);
    }
    ...
    public void deleteBySelectXyz(String acadyear, String semester, String planId, String period,
        ...
        GkSubjectArrange gkSubjectArrange = gkSubjectArrangeDao.findById(plan.getSubjectArrangeId()).orElse(null);
        ...
        //删除年级限制limitIds
 		...
 		List<GkTimetableLimitArrang> limitList = gkTimetableLimitArrangDao
 	                .findGkTimetableLimitArrangBySelectXyz(gkSubjectArrange.getUnitId(), acadyear,semester, period, periodInterval,weekday, limitIds.toArray(new String[]{}));
    ...
    @Override
    public GkTimetableLimitArrang findGkTimetableLimitArrangBySelectXyz(String unitId, String acadyear,
            String semester, String limitId, String period, String periodInterval, String weekday) {
        return gkTimetableLimitArrangDao.findGkTimetableLimitArrangBySelectXyz(unitId, acadyear, semester, limitId,
                period, periodInterval, weekday);
    }
...
//        }
        ...
        gkTimetableLimitArrang.setUnitId(gkSubjectArrange.getUnitId());;
        ...
        String arrangId=dataFilter;
        String remark=dataFilter;
        if(StringUtils.isNotBlank(dataFilter)){
        	if(dataFilter.indexOf("#")>0){
        		arrangId=dataFilter.split("#")[0];
        		remark = dataFilter.split("#")[1];
        	}
        }
        
        gkTimetableLimitArrang.setRemark(remark);
        gkTimetableLimitArrang.setArrangId(arrangId);
        ...
        if(CollectionUtils.isNotEmpty(classList)){
        	for(int i=0;i<classList.size();i++){
     	        ...
     	        gkTimetableLimitArrang.setId(UuidUtils.generateUuid());
     	        //BaseConstants.PC_KC+dataFilter
     	        gkTimetableLimitArrang.setRemark(remark);
     	        insertList.add(gkTimetableLimitArrang);
     		}
        }
    ...
    @Override
    public List<GkTimetableLimitArrang> findGkTimetableLimitArrangListbyLimitIds(String unitId,
            String searchAcadyear, String searchSemester, String limitType, String... limitIds) {
        return gkTimetableLimitArrangDao.findGkTimetableLimitArrangListbyLimitIds(unitId, searchAcadyear,
                searchSemester, limitType, Arrays.asList(limitIds));
    }

    @Override
	public void deleteByRoundsId(String unitId, String acadyear, String semester, String roundsId) {
		gkTimetableLimitArrangDao.deleteByLimitId(unitId,acadyear, semester, roundsId,GkElectveConstants.LIMIT_TYPE_6);
		gkTimetableLimitArrangDao.deleteByArrangeId(unitId,acadyear, semester, roundsId,GkElectveConstants.LIMIT_TYPE_4);
	}
    @Override
    public void notUsing(String unitId, String acadyear, String semester, String roundsId) {
    	gkTimetableLimitArrangDao.notUsingByLimitId(unitId,acadyear, semester, roundsId,GkElectveConstants.LIMIT_TYPE_6);
		gkTimetableLimitArrangDao.notUsingByArrangeId(unitId,acadyear, semester, roundsId,GkElectveConstants.LIMIT_TYPE_4);
    }
    
    @Override
    public void yesUsing(String unitId, String acadyear, String semester, String roundsId) {
    	gkTimetableLimitArrangDao.yesUsingByLimitId(unitId,acadyear, semester, roundsId,GkElectveConstants.LIMIT_TYPE_6);
		gkTimetableLimitArrangDao.yesUsingByArrangeId(unitId,acadyear, semester, roundsId,GkElectveConstants.LIMIT_TYPE_4);
    }
	...
	public List<GkTimetableLimitArrang> findGkTimetableLimitArrangListIsUsing(
		...
		return gkTimetableLimitArrangDao.findGkTimetableLimitArrangListIsUsing(unitId,searchAcadyear,searchSemester,limitId, limitType);
	}
	...
	public List<GkTimetableLimitArrang> findByArrangeIdType(String unitId, String acadyear,String semester,
		...
		return gkTimetableLimitArrangDao.findByArrangeIdType(unitId,acadyear,semester,arrangeId,limitType);
	}
