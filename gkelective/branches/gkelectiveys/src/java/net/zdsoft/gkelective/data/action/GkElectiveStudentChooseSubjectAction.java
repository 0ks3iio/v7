 ...
 * $Id: GkElectiveStudentChooseSubjectAction.java 4846 2017-09-21 08:47:27Z duhc $
 */
...
/**
 * @author wangk
 * @version $Revision: 4846 $, $Date: 2017-09-21 16:47:27 +0800 (周四, 21 九月 2017) $
 */
@Controller
...
public class GkElectiveStudentChooseSubjectAction extends BaseAction {
    ...
    public String showIndex(ModelMap map) {
        ...
        return "/gkelectiveys/studentChooseSubject/studentChooseSubjectIndex.ftl";
    }
...
//        	gkSubjectArrange.getGsaEnt().setArrangeName(grade.getOpenAcadyear().substring(0, 4)+"级"+grade.getGradeName()+"新高考项目");
        ...
        return "/gkelectiveys/studentChooseSubject/studentChooseSubjectList.ftl";
    }
