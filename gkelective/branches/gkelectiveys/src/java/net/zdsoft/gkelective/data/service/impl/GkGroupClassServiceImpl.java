...
public class GkGroupClassServiceImpl extends BaseServiceImpl<GkGroupClass, String> implements GkGroupClassService{
	...
	@Override
	public void saveGroup(List<GkGroupClass> groupClassList, List<GkGroupClassStu> groupClassStuList, String roundsId) {
		this.deleteByRoundsId(roundsId, null);
		this.saveGroup(groupClassList, groupClassStuList);
	}
}
