...
<div class="box box-default">
	...
	<div class="box-header">
		<ol class="steps">
			...
			<#if rounds.openTwo?default('')=='1' || (rounds.openTwo?default('')=='0' && rounds.openHand?default('0')=='0')>
			...
			<#elseif rounds.openTwo?default('')=='0' && rounds.openHand?default('0')=='1'>
			<li class="first completed perarrange-step click-btn">
				<a href="javascript:" style="text-decoration:none">
					<span class="step"></span>
					<h4>手动排班</h4>
			...
			<#if rounds.openHand?default('0')!='1'>
