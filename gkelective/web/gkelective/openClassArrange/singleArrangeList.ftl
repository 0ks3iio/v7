		...
		<tbody>
			...
			<tr>
				...
				<td>
					...
					<input type="text" class="inputClaNumClass" nullable="false" vtype="int" style="width:80%" id="${gkc_index}_inputClaNum" name="dtos[${gkc_index}].claNum" class="form-control pull-left num-input" value="<#if gkc.claNum?default(0) !=0 >${gkc.claNum?default(0)}</#if>" onchange="doChangeClassNum(this,'${gkc_index}')">
					<#else>
				...
				<td>
					...
					<input type="text" style="width:40%" class="form-control pull-left num-input" id="${gkc_index}_num" nullable="false" vtype="int" max="9999" min="1" groupIndex="${gkc_index}" stuMax="${gkc.sumNum?default(0)}" clsMax="${gkc.clsMax}" name="dtos[${gkc_index}].num" value="<#if !(gkc.maxNum??)><#else>${gkc.num?default(0)}</#if>">
					<span class="pull-left">~</span><input type="text" style="width:40%" class="form-control pull-left" id="${gkc_index}_maxNum" nullable="false" vtype="int" max="9999" min="1" groupIndex="${gkc_index}" stuMax="${gkc.sumNum?default(0)}" clsMax="${gkc.clsMax}" name="dtos[${gkc_index}].maxNum" value="<#if gkc.maxNum??>${gkc.maxNum}<#else></#if>">
					</div>
					<#--
		...
		<tbody>
			...
			<tr>
				...
				<td>
					...
					<input type="text" class="inputClaNumClass" nullable="false" vtype="int" style="width:80%" id="${bindex}_inputClaNum" name="dtos[${bindex}].claNum" class="form-control pull-left num-input" value="<#if gkc.claNum?default(0) !=0 >${gkc.claNum?default(0)}</#if>" onchange="doChangeClassNum(this,'${bindex}')">
					<#else>
						<#if gkc.claNum?default(0) !=0 >${gkc.claNum?default(0)}</#if>
					</#if>
				</td>
				<td>
					<#if canEdit>
					<div class="filter-content">
						<input type="text" style="width:40%" class="form-control pull-left num-input" id="${bindex}_num" nullable="false" vtype="int" max="9999" min="1" groupIndex="${bindex}" stuMax="${gkc.sumNum?default(0)}" clsMax="${gkc.clsMax}" name="dtos[${bindex}].num" value="<#if !(gkc.maxNum??)><#else>${gkc.num?default(0)}</#if>">
						<span class="pull-left">~</span><input type="text" style="width:40%" class="form-control pull-left" id="${bindex}_maxNum" nullable="false" vtype="int" max="9999" min="1" groupIndex="${bindex}" stuMax="${gkc.sumNum?default(0)}" clsMax="${gkc.clsMax}" name="dtos[${bindex}].maxNum" value="<#if gkc.maxNum??>${gkc.maxNum}<#else></#if>">
					</div>
					<#--
...
function toPaiban(){
	...
	$.ajax({
		url:'${request.contextPath}/gkelective/${roundsId!}/openClassArrange/singleResult/save',
		dataType : 'json',
		type:'post',
		success:function(data) {
			var jsonO = data;
...
function toPaiban2(){
	$.ajax({
		url:'${request.contextPath}/gkelective/${roundsId!}/openClassArrange/singleResult/check',
		dataType : 'json',
		type:'post',
		success:function(data) {
			var jsonO = data;
...
function cutPaiban(){
	$.ajax({
		url:'${request.contextPath}/gkelective/${roundsId!}/openClassArrange/singleResult/cut',
		dataType : 'json',
		type:'post',
		success:function(data) {
			var jsonO = data;
