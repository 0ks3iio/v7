<div class="box box-default" >
	<div class="chosenSubjectHeaderClass noprint">
...
<script>
	...
	function findByCondition(){
		var url = '${request.contextPath}/gkelective/${roundsId!}/openClassArrange/group/class/needGoClassList/page?'+searchUrlValue('.chosenSubjectHeaderClass');
