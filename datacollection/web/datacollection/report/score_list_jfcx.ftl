...
<@dcm.columnOne label="类型（排除）" isCondition=true operation="<>" columnId="score_type"  value=score_type! type="select" cselect=",-- 请选择 --;6,加班;27,值班;3,团建;4,分享;5,考勤;10,开拓;11,拜访;12,出差;13,汇报;14,表扬;15,培训;16,建议;17,证书;18,招聘;19,育人;20,会议;21,计划;22,投诉;23,批评;24,违纪;25,协作;26,方案" /> 
...
<td><@dcm.dcRdButton isConditionButton=true value="查找" url="/dc/report/listReportData/" + _report.id reportId=_report.id checkReturn="doCookie()"/>
</td>
</tr></table>
<p ></p>
