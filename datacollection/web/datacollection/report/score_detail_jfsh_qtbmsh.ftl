...
<p align="center">
说明：其他部门向本部门申请的积分，审核通过后，提交到研发中心审核。
...
<table align="center" class="table-bordered ">
	<@dcm.rowOne readonly=true nullable=false label="员工名字" type="select" value=_data.teacher_id! columnId="teacher_id" vsql="select id, teacher_name from base_teacher where is_deleted = 0 and  unit_id = '" + _unitId + "'" />
...
<#if _updatable>
        <@dcm.rowOne readonly=!_updatable nullable=false label="状态" columnId="state" type="select" value="2" cselect="1,待审核;2,初审通过;4,审核不通过" />
<#else>
        <@dcm.rowOne readonly=!_updatable nullable=false label="状态" columnId="state" type="select" value=_data.state!"1" cselect="1,待审核;2,初审通过;3,终审通过;4,审核不通过" />
</#if>
</table>
<p ></p>
<p align="center">
