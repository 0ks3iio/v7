...
<div class="container-wrap">
	<div id="container">
	    <div class="content-border">
	        	...
	        	<tr>
	            	<td width="449"></td>
	                <td width="300"><h3 class="f-18 t-center">重置密码</h3></td>
	                <td width="449"></td>
	            </tr>
	            <tr>
	            	<td></td>
...
<script src="${request.contextPath}/static/js/login/register.js"></script>
<script>
$(function(){
...
function savePassword(){
	...
	var options = {  
		url:'${request.contextPath}/homepage/register/resetPwd',
		...
		success:function(data){
			...
			if(res.success){
				window.location.href='${request.contextPath}/homepage/register/resetPwdSuccess?mobilePhone='+$("#mobilePhone").val();
			}else{
				isSubmit=false;
