			...
			<div class="col-sm-9">
				<div class="box box-default">
					<div class="box-body" id="print">
					   ...
					   <#if isHangwai?default(false)><img src="${request.contextPath}/scoremanage/images/logo1.png"/></#if>${unitName!}${acadyear!}学年${semester!}学期学生成绩单</p>
                       <table class="table table-print no-margin" style="height:800px;">
                          <tbody>
                             ...
                             <tr>
                                 ...
                                 <td class="text-center" style="line-height: 1.4;border: 2px solid #333;"><b>杭州外国语学校教务处<br>${nowDate?string('yyyy-MM-dd')!}</b></td>
                             </tr>
                           </tbody>
                        </table>
					</div>
...
<script>
	function doExport(){
		...
		var url="${request.contextPath}/scoremanage/scoreReport/doExport?acadyear="+acadyear+"&semester="+semester+"&classId="+classId+"&examId="+examId;
	...
	function doSearch(studentId){
		...
		var url="${request.contextPath}/scoremanage/scoreReport/searchScoreReport?acadyear="+acadyear+"&semester="+semester+"&classId="+classId+"&studentId="+studentId+"&examId="+examId;
