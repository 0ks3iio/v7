...
<head>
	...
	<link rel="stylesheet" type="text/css" href="${request.contextPath}/static/eclasscard/standard/show/font-awesome/css/font-awesome.css"/>
	<link rel="stylesheet" href="${request.contextPath}/static/eclasscard/standard/show/css/style.css?v=20191216">
	<link rel="stylesheet" href="${request.contextPath}/static/eclasscard/standard/show/plugins/mobiscroll/mobiscroll.full.min.css">
	<link rel="stylesheet" href="${request.contextPath}/static/eclasscard/standard/show/plugins/gallery/css/blueimp-gallery.min.css">
</head>
<body class="index">
		...
		<#include "/eclasscard/standard/show/showMsgtip.ftl">
		<#include "/eclasscard/standard/show/clockStateTip.ftl">
	...
	<div class="layer layer-remove">
		<h2 class="text-center padding-tb-30">确认关闭？</h2>
	</div><!-- E 确认框 -->

<script src="${request.contextPath}/static/eclasscard/standard/show/plugins/jquery/jquery.min.js"></script>
<script src="${request.contextPath}/static/eclasscard/standard/show/plugins/slick/slick.js"></script>
<script src="${request.contextPath}/static/eclasscard/standard/show/plugins/layer/layer.js"></script>
<script src="${request.contextPath}/static/eclasscard/common/show/js/common.use.js?version=4.0"></script>
<script src="${request.contextPath}/static/eclasscard/standard/show/plugins/gallery/js/blueimp-gallery.min.js"></script>
<script src="${request.contextPath}/static/eclasscard/standard/show/plugins/iScroll/iscroll.js"></script>
<script src="${request.contextPath}/static/eclasscard/standard/show/plugins/echarts/echarts.min.js"></script>
<script src="${request.contextPath}/static/eclasscard/standard/show/plugins/mobiscroll/mobiscroll.full.min.js"></script>
...
var isLockFullScreen = false;//当前是否全屏锁定
...
var faceSuc = "${request.contextPath}/static/eclasscard/show/mp3/face_suc.mp3";
...
function showPrompt(type) {
	if (prompt == "true") {
		...
		} else if (type == "faceSuc") {
			promptAudio.src = faceSuc;
		}
		promptAudio.play();
	}
}

function eccCodeMatch(codeStr){
	if(isFullScreenNow){//全屏模式下刷二维码无效
		return;
	}
	var activeTab = $(".menu-list li[class='active']").attr('id');
	var type = $("#clock-tab-type").val();
	if(activeTab=="footTabStuSpace"){
		//学生空间--是否登陆信息
		if($("#mainContainerDiv").find(".quality_space").length>0){
			if(!codeStr||codeStr==''||codeStr=='0' || $.trim(codeStr).length!=32){
				showMsgTip("无效二维码");
				return;
			}
			checkCode(codeStr);
...
<script src="${request.contextPath}/static/eclasscard/standard/show/js/eccPublic.js?version=20190345"></script>
</body>
</html>