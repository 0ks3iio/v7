...
<div class="video-wrap video-wrap-4by3">
	<video id="showVideo" autoplay="true" <#if mute == 1>muted</#if> src=""></video>
</div>
<#else>
<div class="slider-wrap">
	...
	<#if attachFolder?exists&&attachments?exists&&attachments?size gt 0>
		<#list attachments as item>
			<div class="slider-item">
				<div class="img-wrap img-wrap-4by3" style="background-image:url(${request.contextPath}${item.showPicUrl!});"></div>
	...
	<#else>
		<div class="slider-item">
			<div class="img-wrap img-wrap-4by3">
...
<script id="albumScript" src="${request.contextPath}/static/eclasscard/standard/show/js/myscript.js" data="${speedValue!}"></script>
