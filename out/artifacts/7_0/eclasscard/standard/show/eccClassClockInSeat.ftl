            ...
            <div class="box-body">
                <div class="checkin-container">
                    ...
                    <div class="checkin-wrapper">
                        <ul class="checkin-info info-list">
                            <li>应到人数：<em>${sumNum}</em>人<em>|</em></li>
							<li>实到人数：<em id="clockNum">${clockNum}</em>人<em>|</em></li>
							<li>请假人数：<em>${leaveNum}</em>人<em>|</em></li>
							<li>未到人数：<em id="notClockNum">${notClockNum}</em>人<em>|</em></li>
