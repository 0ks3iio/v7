<div id='vacated' class="tab-pane active">
	<ul class="leave-paper-type clearfix showLeave">
		
		<li <#if leaveType=='' ||  leaveType == '1'>class="active"</#if>><a href="javascript:void(0);" onclick="selectLeaveType(1,this)">请假单</a></li>
		<li <#if leaveType == '4'>class="active"</#if>><a href="javascript:void(0);" onclick="selectLeaveType(4,this)">长期通校申请单</a></li>
	</ul>
...
<script>								
	$(document).ready(function(){
		<#if leaveType==''>
			selectLeaveType(1,this);
		<#else>
			selectLeaveType("${leaveType!}",this);
		</#if>
	});
	
	function selectLeaveType(selType,objthis) {
