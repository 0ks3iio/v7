...
<script>
    ...
    function changeClassList(){
        ...
        var classId=$("#classId");
        $.ajax({
            url:"${request.contextPath}/exammanage/common/queryExamSubClassList",
            data:{examId:examId,unitId:'${unitId!}',subjectId:subjectId},
            dataType: "json",
            success: function(data){
                //debugger;
                var infolist=data.infolist;
                ...
                if(infolist==null || infolist.length==0){
                    ...
                    for(var i = 0; i < infolist.length; i ++){
                        ...
                        classHtml+=" >"+infolist[i].className+"</option>";
                        classId.append(classHtml);
                    }
                }
                searchCompareExam();
            }
    ...
    function searchList(){
        ...
        var url='${request.contextPath}/examanalysis/examNewClass/getExamNewTeachList13/page'+c2;
