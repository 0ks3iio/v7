...
<#macro gradeClassForSchoolInsetTree id="gradeClassForSchoolInsetTree" class="" height="" parameter="" click="">
	<@findTree id=id class=class height=height url="/stuwork/tree/gradeClassForSchoolInsetTree/page" parameter=parameter click=click>
	<#nested>
	</@findTree>
</#macro>
...
<#macro gradeClassStudentForSchoolInsetTree id="gradeClassStudentForSchoolInsetTree" class="" height="" parameter="" click="">
    <@findTree_1 id=id class=class height=height url="/stuwork/tree/gradeClassStudentForSchoolInsetTree/page" parameter=parameter click=click>
    <#nested>
    </@findTree_1>
</#macro>
