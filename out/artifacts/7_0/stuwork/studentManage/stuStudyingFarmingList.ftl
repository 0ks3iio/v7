				...
				<table class="table table-striped table-hover">
					...
					<#if studentList?exists && studentList?size gt 0>
						...
						<tr>
							...
							<td>${stu.className!}</td>
							<td>
								<select name="dyStuStudyingFarmingList[${stu_index!}].gradeId" id="dyStuStudyingFarmingList${stu_index!}gradeId" class="form-control">
							...
							<td>
								<select name="dyStuStudyingFarmingList[${stu_index!}].acadyear" id="dyStuStudyingFarmingList${stu_index!}acadyear" class="form-control acadyear">
								        <option value="">--请选择--</option>
							...
							<td>
								<select name="dyStuStudyingFarmingList[${stu_index!}].semester" id="dyStuStudyingFarmingList${stu_index!}semester" class="form-control">
								        <option value="">--请选择--</option>
							...
							<td>
								<input type="text" class="form-control" name="dyStuStudyingFarmingList[${stu_index!}].remark" id="dyStuStudyingFarmingList${stu_index!}remark" value="${stu.remark!}" maxLength="2000">
							</td>
							<td>
								<a href="javascript:doClear('${stu_index!}');" class="table-btn color-red">清除</a>
							</td>
							<input type="hidden" class="form-control" name="dyStuStudyingFarmingList[${stu_index!}].studentId" value="${stu.id!}">
						</tr>
						</#list>
					</#if>														
					</tbody>
...
function saveTraning(){
   ...
   var check = checkValue('#myDiv');
    ...
    var enter = $('#enter').val();
	var options = {
		url : "${request.contextPath}/stuwork/studyingFarming/save?classId="+classId+"&gradeId="+gradeId+"&enter="+enter,
		dataType : 'json',
...
function doExport(){
   ...
   var gradeId = $('#gradeId').val();
   var enter = $('#enter').val();
   document.location.href = "${request.contextPath}/stuwork/studyingFarming/export?gradeId="+gradeId+"&classId=" + classId+"&enter="+enter;
}

function doImport(){
	$(".model-div").load("${request.contextPath}/stuwork/studyingFarming/import/index");
}

function doClear(index){
    var select1 = document.getElementById("dyStuStudyingFarmingList"+index+"gradeId");     
    ...
    var select2 = document.getElementById("dyStuStudyingFarmingList"+index+"acadyear");     
    ...
    var select3 = document.getElementById("dyStuStudyingFarmingList"+index+"semester");     
    ...
    $("#dyStuStudyingFarmingList"+index+"remark").val("");
}
</script>