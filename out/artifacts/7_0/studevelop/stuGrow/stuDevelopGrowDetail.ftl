    ...
    <div class="box-body">
            ...
            <#list activities as activity>
                ...
                <div class="img-box">
                    ...
                    <p class="letter-break" style="word-break: break-all;">${activity.actRemark!}</p>
                </div>
            </#list>
    ...
    <div class="box-body">
            ...
            <#list activities as activity>
                ...
                <div class="img-box">
                    ...
                    <p class="letter-break" >${activity.content!}</p>
                </div>
            </#list>
    </div>
</div>
...
<head>
    <meta charset="UTF-8">
    <title>成长手册</title>
    <link rel="stylesheet" href="${request.contextPath}/studevelop/css/style.css">
...
<main class="main">
        ...
        <div class="buttons">
            <span style="color:red;display:none;" id="error-span"></span>
    ...
    <div class="container">
        <div class="box header">
        <#if stuIntroduction?exists && stuIntroduction.imgPath?exists >
           <img  width="160" height="160"  class="card-stu-img"  src="${stuIntroduction.imgPath!}" alt="">
         <#else>
         	<img width="160" height="160"  class="card-stu-img" src="${request.contextPath}/static/jscrop/images/portrait_big.png" />
         </#if>
        </div>
                ...
                <ul class="subject-list">
                    ...
                    <li>
                        <ul class="attend-list clearfix">
                            ...
                            <li><span>实际出席</span><span><#assign studyLastDays=(stuCheckAttendance.studyDate-stuCheckAttendance.businessVacation-stuCheckAttendance.illnessVacation)><#if studyLastDays lt 0>0<#else>${studyLastDays?default(0)}</#if>天</span></li>
