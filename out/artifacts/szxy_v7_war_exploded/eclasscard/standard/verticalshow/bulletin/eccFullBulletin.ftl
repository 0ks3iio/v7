...
<#else>
	<div class="post-fullscreen <#if bulletin.templetType == 3>post-fullscreen-welcome<#elseif bulletin.templetType == 2>post-fullscreen-happy<#else>post-fullscreen-default</#if>">
		<div class="post-fullscreen-content <#if bulletin.templetType == 3>post-fullscreen-content-welcome<#elseif bulletin.templetType == 2>post-fullscreen-content-happy<#else>post-fullscreen-content-default full-of-all</#if>">
			<#if bulletin.templetType == 1><h2>${bulletin.title!}</h2>
			<p>${bulletin.content!}</p>
			<#elseif bulletin.templetType == 2>
