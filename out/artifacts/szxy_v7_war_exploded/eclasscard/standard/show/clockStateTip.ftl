...
<div class="layer-checkin">
	<div class="layer-checkin-header">
		<img id="tipHeaderImg" src="${request.contextPath}/static/eclasscard/standard/show/images/female.png" alt="" class="stu-avatar">
...
function showStuClockMsg(result){
    ...
    if(result.status==1){
    	$("#tipShowMsgDiv").html('<div class="layer-checkin-state successed"> <i class="icon icon-successed"></i>签到成功'+result.msg+'</div>')
