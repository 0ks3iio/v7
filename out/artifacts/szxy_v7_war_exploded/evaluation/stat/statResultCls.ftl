...
function toResultSub(){
	...
	var url =  '${request.contextPath}/evaluate/stat/statResultSub/page?evaluateType=${evaluateType!}&projectId=${project.id!}&subjectId='+subjectId+'&classId='+classId;
	$(".model-div").load(url);
}
...
function toResultTxt(teaId,subId,clsId){
	...
	var classId = $('#classId').val();
	if(teaId && teaId != ""){
		var url =  '${request.contextPath}/evaluate/stat/statResultTxt/page?subjectId='+subjectId+'&subId='+subId+'&clsId='+clsId+'&teaId='+teaId+'&classId='+classId+'&teacherId='+teacherId+'&evaluateType=${evaluateType!}&projectId=${project.id!}';
	}
	$(".model-div").load(url);
}
...
function searTable(){
	...
	var classId = $('#classId').val();
	var teaId = $('#teaId').val();
	var url =  '${request.contextPath}/evaluate/stat/statResult/page?subjectId='+subjectId+'&classId='+classId+'&teaId='+teaId+'&evaluateType=${evaluateType!}&projectId=${project.id!}';
	$(".model-div").load(url);
}
$(function(){
	// 文本断行
