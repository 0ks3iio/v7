...
<script type="text/javascript">
    function showStu(studentId){
        var url = '${request.contextPath}/stutotality/result/getStuAcadList?studentId='+studentId;
        $("#showTabDiv").load(url);
    }
</script>
...
<script type="text/javascript">
    ...
    function doImport() {
        ...
        var url = '${request.contextPath}/stutotality/stuAcadList/import/main?classId=' + classId ;
        $("#showTabDiv").load(url);
