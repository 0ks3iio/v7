...
<script>
	...
	<#-- function changeExam(){
		...
		var stuId=$("#stuId");
		$.ajax({
			url:"${request.contextPath}/studevelop/leagueRecord/classIds",
	...
	function changeClass(){
		...
		var stuId=$("#stuId");
		$.ajax({
			url:"${request.contextPath}/studevelop/leagueRecord/stuIds",
	...
	function LeagueList(){
		...
		var url='${request.contextPath}/studevelop/leagueRecord/listAll'+ass;
		$(".showList").load(url);
	}
	...
	function changeStuId(){
		...
		var url='${request.contextPath}/studevelop/leagueRecord/list'+ass;
		$(".showList").load(url);
	}
