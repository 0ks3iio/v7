...
<script>
    ...
    function businessDataImport(){
        ...
        var params='${dutySituation!}';
        dataimport(params);
    }
    function goBack() {
        $(".model-div").load("${request.contextPath}/studevelop/dutySituation/index/page?acadyear=${acadyear}&semester=${semester}&classId=${classId}&performMonth=${performMonth!}");
    }
