                        ...
                        <div class="box-body">
                            ...
                            <table class="table  table-print text-center no-margin">
                                ...
                                <tr>
                                    ...
                                    <td width="21%"><b>思想道德素质</b></td>
                                    <#if templateItemList?exists && templateItemList?size gt 0>
                                        <#assign  subjectSize = templateItemList?size +2 >
                                    </#if>
                                    <td width="42%" colspan="${subjectSize?default(2)}"><b>科学文化素质</b></td>
                                    <td width="26%" colspan="2"><b>身心健康素质</b></td>
                                </tr>
                                <#assign totalCols = 2+subjectSize?default(5)+2 >
                                <tr>
                                    <td><b>操行<br/>等级</b></td>
                                    <td><b>${stuEvaluateRecord.evaluateLevel?default('')}</b></td>
                                    <td width="7%"><b>学科</b></td>
                                    <td width="11%"><b>项目</b></td>
                                    <#if templateItemList?exists && templateItemList?size gt 0>
                                        <#list templateItemList as item>
                                            <td style="word-break: break-all;word-wrap: break-word;"<#if item_index==templateItemList?size-1>width="7%"</#if>><b>${item.itemName!}</b></td>
                                        </#list>
                                    </#if>
                                    <td><b>项目</b></td>
                                    <td width="10%"><b>等第</b></td>
                                </tr>
                                    <#assign ind=0 />
