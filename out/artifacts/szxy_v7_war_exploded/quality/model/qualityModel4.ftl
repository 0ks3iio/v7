<div class="box box-default">
    <div class="box-body">
        <div class="filter" style="margin-bottom: 10px;">
            <a href="javascipt:void(0)" onclick="showListDiv('74041','奖励设置','/stuwork/studentReward/studentRewardSettingPage','74040');">奖励设置</a>
        </div>
        <div class="filter" style="margin-bottom: 10px;">
            <a href="javascipt:void(0)" onclick="showListDiv('74042','奖励录入','/stuwork/studentReward/studentRewardInputPage','74040');">奖励录入</a>
        </div>
        <div class="filter">
            <a href="javascipt:void(0)" onclick="showListDiv('74043','奖励查询','/stuwork/studentReward/studentRewardSearchPage','74040');">奖励查询</a>
        </div>
    </div>
</div>
