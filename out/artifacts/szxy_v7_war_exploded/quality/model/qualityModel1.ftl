<div class="box box-default">
    <div class="box-body">
        ...
        <div class="filter" style="margin-bottom: 10px;"><a href="javascipt:void(0)" onclick="showListDiv('86905','综合素质折分设置','/comprehensive/quality/score/index/page','74120');">综合素质折分设置</a></div>
        <div class="filter" style="margin-bottom: 10px;"><a href="javascipt:void(0)" onclick="showListDiv('86908','成绩折分计算','/comprehensive/qualityScoreStat/index/page','74120');">成绩折分计算</a></div>
        ...
        <div class="filter"><a href="javascipt:void(0)" onclick="showListDiv('74043','奖励查询','/stuwork/studentReward/studentRewardSearchPage','74040');">奖励查询</a></div>
