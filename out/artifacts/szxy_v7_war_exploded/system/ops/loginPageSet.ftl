        ...
        <form id="form-field-1" enctype="multipart/form-data" method="post" role="form">
            ...
            <div class="form-horizontal">
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <label>
                            <input id="js-userpalyer" class="wp wp-switch js-userpalyer" type="checkbox" <#if loginOption.palyer!true> checked="checked" </#if> />
                            <span class="lbl"></span>
                        </label>
                    </div>
                    <input type="hidden" id="player" name="palyer" value="${loginOption.palyer?string('true', 'false')}"/>
                </div>
            </div>
            ...
            <div class="form-horizontal">
                <div class="form-group">
                    <label class="col-sm-3 control-label">是否启用找回密码功能（Passport提供）</label>
                    <div class="col-sm-9">
                        <label>
                            <input id="js-forgetPassword" class="wp wp-switch js-forgetPassword" type="checkbox" <#if loginOption.forgetPassword!true> checked="checked" </#if> />
                            <span class="lbl"></span>
                        </label>
                    </div>
                    <input type="hidden" id="forgetPassword" name="forgetPassword" value="${loginOption.forgetPassword?string('true', 'false')}"/>
                </div>
            </div>

            <div class="form-horizontal">
                <div class="form-group">
                    <label class="col-sm-3 control-label">是否启用Favicon</label>
                    <div class="col-sm-9">
                        <label>
                            <input id="js-favicon" class="wp wp-switch js-favicon" type="checkbox" <#if loginOption.favicon!true> checked="checked" </#if> />
                            <span class="lbl"></span>
                        </label>
                    </div>
                    <input type="hidden" id="favicon" name="favicon" value="${loginOption.favicon?string('true', 'false')}"/>
                </div>
            </div>
            <!--登录页面相关的参数设置-->
            <#--<div class="form-horizontal">
...
function doSearchUnit(){
    ...
    $('#js-forgetPassword').change(function(){
        if ($(this).prop('checked') !== true) {
            $(this).closest('.form-group').nextAll().removeClass('hidden');
            $('#forgetPassword').val(false)
        } else {
            $(this).closest('.form-group').nextAll().addClass('hidden');
            $('#forgetPassword').val(true)
        }
    });
    $('#js-favicon').change(function(){
        if ($(this).prop('checked') !== true) {
            $(this).closest('.form-group').nextAll().removeClass('hidden');
            $('#favicon').val(false)
        } else {
