<form id="classflow_import_upload" enctype="multipart/form-data">
    <div class="row" style="height:100%;">
        <div class="col-xs-12 col-lg-12 col-md-12 col-sm-12" >
            <!-- PAGE CONTENT BEGINS -->
            <div class="import-wrap">
                <div class="import-header">
                    <h4 class="import-title">学生转班批量导入步骤：</h4>
                </div>
                <div class="import-body">
                    <div class="import-step clearfix">
                        ...
                        <div class="import-content">
                            <p>下载模板：
                                <a href="javascript:void(0);" class="btn-import-template">学生转班模板</a>
                            </p>
                        </div>
                    </div>
                    <div class="import-step clearfix">
...
<script>
    ...
    var listUrl = '${request.contextPath}/basedata/classflow/import/list/page';
    var isLoop = true;
    ...
    function resetDiv(){
        $("#classflow_import_upload").parent("div").parent("div").css("height","100%");
    }
    ...
    $('.page-content-area').ace_ajax('loadScripts', scripts, function() {
        ...
        $(".btn-import-template").on("click",function(){
            location.href = '${request.contextPath}/basedata/classflow/template';
        });

        var url = '${request.contextPath}/basedata/classflow/import';
        ...
        $(".btn-studentflowin-start").on("click",function(){
            ...
            try{
                $("#classflow_import_upload").ajaxSubmit(options);
            }catch(e){
                //showMsgError('保存学生失败！');
            }
        });
