		...
		<ul class="honor-list honor-list-h js-honor-slick">
			...
			<li class="honor-item">
				<div class="honor-photo-frame">
					<div class="honor-photo-wrap img-size">
					<#if item.style == 1>
					<img src="${request.contextPath}/eclasscard/standard/show/images/honor-flag.png" alt="">
					<#elseif item.style == 2>
					<img src="${request.contextPath}/eclasscard/standard/show/images/honor-cup.png" alt="">
					<#else>
					<img src="${request.contextPath}/eclasscard/standard/show/images/honor-medal.png" alt="">
					</#if>
					</div>
				</div>
		...
		<#else>
			<div class="no-data no-data-small center">
				<div class="no-data-content">
					<img src="${request.contextPath}/eclasscard/standard/show/images/no-content.png" alt="">
					<p>暂无内容</p>
				</div>
			</div>
		</#if>
