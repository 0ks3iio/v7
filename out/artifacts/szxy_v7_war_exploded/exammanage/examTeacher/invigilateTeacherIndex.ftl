...
function showFilterList(){
	...
	var url =  '${request.contextPath}/exammanage/examTeacher/invigilateTeacherList/page?examId=${examId!}'+str;
	$("#filterList").load(url);
}

function setTeacher() {
	var url = "${request.contextPath}/exammanage/examTeacher/invigilateTeacherInfo/page?examId=${examId!}&courseSize=${courseList?size}";
