                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-horizontal">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-2">
                                                <div class="input-group form-num">
                                                    <input class="form-control creditScore" name="usualScore" style="width: 200px"  id="usualScore" type="text" placeholder="请输入平时成绩" value="${creditSet.usualScore!}" onchange="calSumScore()"/>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-2">
                                                <div class="input-group form-num">
                                                    <input class="form-control creditScore" type="text" name="moduleScore" style="width: 200px" id="moduleScore" placeholder="请输入模块成绩" value="${creditSet.moduleScore!}" onchange="calSumScore()"/>
                                                    <span class="input-group-btn">
                                                      <a class="btn btn-default" type="button">
                                                        <i class="fa fa-angle-up" onclick="add(this)"></i>
                                                      </a>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-2">
                                                <div class="input-group form-num">
                                                    <input class="form-control creditScore" type="text" name="dailyScore" style="width: 200px" id="dailyScore" placeholder="请输入日常表现分" value="${creditSet.dailyScore!}" onchange="calSumScore()"/>
                                                    <span class="input-group-btn">
                                                      <a class="btn btn-default" type="button">
                                                        <i class="fa fa-angle-up" onclick="add(this)"></i>
                                                      </a>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-2">
                                                <div class="input-group form-num">
                                                    <input class="form-control creditScore" name="passLine" style="width: 200px" id="passLine" type="text" placeholder="请输入及格线" value="${creditSet.passLine!}"/>
                                                    <span class="input-group-btn">
                                                      <a class="btn btn-default" type="button">
                                                        <i class="fa fa-angle-up" onclick="add(this)"></i>
                                                      </a>
                                                        ...
                                                        <#if item.parentId?default("")?trim?length lt 1>
                                                            <#if item.subSetList?exists&& (item.subSetList?size > 0)>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <div class="input-group form-num">
                                                                            <input class="form-control creditScore" type="text" name="dailySetList[${index}].score" value="${item1.score!}" placeholder='请输入...'>
                                                                            <span class="input-group-btn">
                                                                                <a class="btn btn-default" type="button">
                                                                                    <i class="fa fa-angle-up" onclick="add(this)"></i>
                                                                                </a>
        ...
        $("#edit-btn").on("click", function() {
            ...
            layer.open({
                ...
                yes:function (index,layero) {
                    var hasNull=false;
                    $("#subForm1").find("input[class='form-control credit-control']").each(function () {
                        if(!$(this).val()){
                            hasNull = true;
                            return;
                        }
                    ...
                    if(hasNull){
                        layerTipMsg(false,"提示!","分项或子项目名称不能有空!");
                        return;
                    }
