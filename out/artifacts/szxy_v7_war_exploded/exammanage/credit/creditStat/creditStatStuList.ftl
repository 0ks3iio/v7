    ...
    <div class="box-body">
        ...
        <div class="filter">
            <div class="filter-item">
                      ...
                      ><span>学生：</span><span>${studentName!}</span></span
                      >
            </div>
            <div class="filter-item">
                      <span class="filter-name"
                                ...
                                <#--//比例-->
                                    ...
                                    <#if passScore gt totalScore?number>
                                        ...
                                        <#if listMap5?size gt 0&&listMap5[subjectId]??>
                                            ...
                                            <#assign passScore=passScore?number>
                                        <#--//补考总分-->
                                            <td><#if passScore gt resitTotalScore?number><span class="color-red">${resitTotalScore!}</span><#else ><span class="color-blue">${resitTotalScore!}</span></#if></td>
                                        <#--学分-->
                                            <td>
