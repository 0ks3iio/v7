...
<script type="text/javascript">
	...
	function showList1(){
		var url =  '${request.contextPath}/exammanage/edu/examResult/list1/page';
		$("#showList1").load(url);
	}
	function showList2(){
		 ...
		 var str = "?searchAcadyear="+searchAcadyear+"&searchSemester="+searchSemester+"&searchGradeCode="+searchGradeCode;
	     var url =  '${request.contextPath}/exammanage/edu/examResult/list2/page'+str;
		 $("#showList2").load(url);
	}
