...
<div class="table-container">
	...
	<div class="table-container-header text-right">
		<a href="javascript:" class="btn btn-blue js-setFilter0"  onclick="showStuList1()">查询</a>
...
<script>
	...
	function showStuList() {
		...
		var url = '${request.contextPath}/exammanage/edu/quality/list?examId='+examId+'&schoolId='+schoolId;
		$("#stuList").load(url);
	}
	
	function showStuList1(){
		var examId = $("#examId").val();
		var schoolId = $("#schoolId").val();
		var field = $("#field").val();
		var keyWord = $("#keyWord").val();
		var url = '${request.contextPath}/exammanage/edu/quality/list?examId='+examId+'&schoolId='+schoolId+"&field="+field+"&keyWord="+keyWord;
		$("#stuList").load(url);
	}
