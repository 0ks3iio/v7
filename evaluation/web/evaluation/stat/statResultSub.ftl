	...
	<div class="filter baseData-inner-wrap">
		<div class="filter-item">
			...
			<div class="filter-item">
				...
				<div class="filter-content">
					<@popup.selectOneTeacher clickId="teacherName" id="teacherId" name="teacherName" handler="toResultSub()">
						<input type="text" class="form-control" id="teacherName" value="${teacherName!}"/>
...
function toResultSub(){
	...
	var url =  '${request.contextPath}/evaluate/stat/statResultSub/page?evaluateType=${evaluateType!}&projectId=${project.id!}&subjectId=${subjectId!}&classId=${classId!}&subId='+subId+'&teacherId='+teacherId;
	$(".model-div").load(url);
}
function blackTable(){
	var url =  '${request.contextPath}/evaluate/stat/statResult/page?subjectId=${subjectId!}&classId=${classId!}&evaluateType=${evaluateType!}&projectId=${projectId!}';
	$(".model-div").load(url);
}
$(function(){
	// 文本断行
