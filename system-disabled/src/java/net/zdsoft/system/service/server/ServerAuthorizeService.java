 ...
 */
public interface ServerAuthorizeService extends BaseService<ServerAuthorize, String> {
     ...
     *
     */
    List<Server> listServers(String unitId, Integer unitClass, Integer ownerType, Integer[] orderTypes,
