...
public class InterfaceParamAction extends BaseAction{
	...
	public String showIndex(ModelMap map,String interfaceId){
    	...
    	return "/system/interfaceManage/param/paramIndex.ftl";
	}
    ...
    public String findParam(ModelMap map,String interfaceId) {
		...
		return "/system/interfaceManage/param/paramList.ftl";
    }
    ...
    public String editParam(String paramId, String interfaceId,ModelMap map) {
		...
		return "/system/interfaceManage/param/paramEdit.ftl";
    }
	/**
     * 删除参数
     * @param paramId
