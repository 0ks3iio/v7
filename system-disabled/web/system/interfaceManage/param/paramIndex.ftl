<a href="javascript:" onclick="showTab('1')" class="page-back-btn"><i class="fa fa-arrow-left"></i> 返回</a>
...
function showParamList(){
	var url =  '${request.contextPath}/system/interface/param/findParam?interfaceId='+'${interfaceId!}';
	$(".table-container").load(url);
}

//登记参数
$('.filter .js-checkIn').on('click', function(e){
	$('.layer-param-detailedId').load("${request.contextPath}/system/interface/param/editParam?interfaceId="+'${interfaceId!}',function(){			
	layer.open({
				type: 1,
				shade: .5,
				title: '新增参数',
