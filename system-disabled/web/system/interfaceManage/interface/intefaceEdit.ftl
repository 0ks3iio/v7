<div class="layer-content">
	<div class="form-horizontal">
		...
		<div class="form-group">
			...
			<div class="col-sm-9" >
			  <select name="" id="dataType" class="form-control">
		...
		<div class="form-group">
			...
			<div class="col-sm-9" >
			  ...
			  <#if interface?exists> value="${interface.type!}" </#if> />
			</div>
		</div>
		<div class="form-group">   
		...
		<div class="form-group">
			...
			<div class="col-sm-9" >
			  <input type="text" nullable="false" maxLength="50" id="unitColumnName" class="form-control" 
		...
		<div class="form-group">
			...
			<div class="col-sm-9" >
			  <input type="text" nullable="false" maxLength="50" id="resultType" class="form-control" 
			  <#if interface?exists> value="${interface.resultType!}" </#if> />
			</div>
		</div>
		<div class="form-group"> 
