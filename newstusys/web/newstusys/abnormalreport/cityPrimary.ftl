<div class="filter">
	<div class="filter-item">
		...
		<div class="filter-content">
			<select name="acadyear" id="acadyear" class="form-control" onchange="searchPrimaryReport();">
	...
	<div class="filter-item">
		...
		<div class="filter-content">
			<select name="semester" id="semester" class="form-control" onchange="searchPrimaryReport();">
...
<div class="table-container">
		...
		<table class="table table-bordered no-margin" style="width: 100%;table-layout: fixed;">
			<thead>
				<tr>
				    ...
				    <th width="60px;" rowspan="2" class="text-center">学段</th>
  ...
  <#list dtoList as dto>
  	 <tr>
        ...
        <td width="60px;">${dto.sectionName!}</td>
...
function doExport(){
    ...
    document.location.href="${request.contextPath}/newstusys/student/abnormalreport/cityPrimaryExport?acadyear="+acadyear+"&semester="+semester;
}

function searchPrimaryReport(){
   var acadyear = $('#acadyear').val();
   var semester = $('#semester').val();
   var url =  '${request.contextPath}/newstusys/student/abnormalreport/cityPrimary?acadyear='+acadyear+'&semester='+semester;
