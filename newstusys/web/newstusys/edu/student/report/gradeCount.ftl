<div class="table-container">
		...
		<table class="table table-bordered no-margin" style="width: 100%;table-layout: fixed;">
			<thead>
				<tr>
				    ...
				    <th width="500px;" colspan="5" class="text-center">实际学生总数</th>
				...
				<tr>
				    ...
				    <th width="100px;" class="text-center">班级总数</th>
				    <th width="100px;" class="text-center">学生总数</th>
  ...
  <#list dtoList as dto>
  	 <tr>
        ...
        <td width="100px;">${dto.classCount!}</td>
...
function doExport(){
    ...
    document.location.href="${request.contextPath}/newstusys/student/report/gradeCountExport?unitId="+unitId+"&gradeCode=${gradeCode!}";
}
</script>