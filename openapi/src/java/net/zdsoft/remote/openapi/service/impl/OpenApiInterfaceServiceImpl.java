...
import net.zdsoft.remote.openapi.dao.OpenApiInterfaceJpaDao;
...
public class OpenApiInterfaceServiceImpl extends BaseServiceImpl<OpenApiInterface, String>
	...
	@Autowired
	private OpenApiBusinessTkService openApiBusinessTkService;
	...
	public List<String[]> findDistinctTypeByDataType(Integer dataType) {
		if(dataType == null){
			...
			return openApiInterfaceJpaDao.findDistinctType(dataType);
		}
	}
	...
	public List<String> findDistinctResultTypeByDataType(Integer dataType) {
		if(dataType == null){
			return openApiInterfaceJpaDao.findDistinctResultType();
		}else{
			return openApiInterfaceJpaDao.findDistinctResultTypeByDataType(dataType);
		}
	}
	...
	public List<OpenApiInterface> findByResultTypAndDataType(String type,
			Integer dataType) {
		return openApiInterfaceJpaDao.findByResultTypAndDataType(type,dataType);
	}
