package net.zdsoft.savedata.utils;
...
public class JdbcUtil {
  //获得驱动  
    ...
    //获得url  
    private static String URL = "jdbc:oracle:thin:@192.168.0.155:1521:center";  
    //获得连接数据库的用户名  
    private static String USER = "eis7_develop";  
    //获得连接数据库的密码  
    private static String PASS = "zdsoft";  
  ...
  //关闭连接
    ...
    try {
       ...
       */
      rs = dbmd.getTables(null, null, "SU_ZJ_BASE_EXAM", new String[]{"TABLE","VIEW"}); 
    ...
    ResultSet rs = null;
       ...
       * table - 表名称;可包含单字符通配符("_"),或多字符通配符("%");
             */
            rs = dbmd.getPrimaryKeys(null, null, "SU_ZJ_BASE_EXAM");  
    ...
    try{
       ...
       */
      rs =dbmd.getColumns(null, null, "SU_ZJ_BASE_EXAM", null);
