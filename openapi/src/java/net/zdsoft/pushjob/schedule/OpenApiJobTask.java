...
import net.zdsoft.pushjob.utils.BaseUrlUtils;
...
public class OpenApiJobTask implements BaseJobTask{
	...
	BasePushLoggerService basePushLoggerService = Evn.getBean("basePushLoggerService");
	private static RestTemplate restTemplate = new RestTemplate();
	
	@Override
	public void excute(String jobGroup, String jobName) {
		//jobGroup=ticketKey;jobName=BasePushJob.id
		BasePushJob pushJob = basePushJobService.findOne(jobName);
...
//						解析获取msg
	...
	private String getResponseEntity(String url, String data) {
		...
		if(url.contains("https://proxy.schoolcloud.ys100.com")){
