...
<div id="container" class="fn-clear">
	...
	<div id="content">
    	<div class="item">
    		<h2>Data API</h2>
            <div class="h2-des">
                <p>输入apId点击更新按钮后，才能看到具体的字段以及接口。</p>
                ...
                <p class="fn-clear mt-5"><input type="text" class="input-txt" id="apId" name="apId" value="${apId!}"><a onclick="javascript:updateApId();" href="javascript:void(0);" class="abtn-blue">更新</a><span><font color='red'>&nbsp;${errorMsg!}</font></span></p>
            </div>
...
function goUrl(type){
	...
	<#if apId?default("") != "" && errorMsg?default("") == "">
	$("#interfaceContent").load("${request.contextPath}/remote/openapi/show/showInterface?apId=${apId!}&currentInterfaceType=" + type);
	</#if>
}
...
function updateApId(){
	...
	location.href="${request.contextPath}/remote/openapi/show/updateApId?currentInterfaceType=${currentInterfaceType!}&apId=" + $("#apId").val();
}
