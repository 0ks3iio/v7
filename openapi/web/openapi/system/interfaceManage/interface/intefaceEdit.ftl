		...
		<div class="form-group">
			...
			<div class="col-sm-9" >
			  <select name="dataType" id="dataType" class="form-control inteEdit" onChange="showInterfaceEdit()">
					...
					<option value="4" <#if interface?exists &&interface.dataType== 4>selected</#if>>更新数据接口</option>
			  </select>
			</div>
		</div>
		<div class="form-group">   
			...
			<div class="col-sm-9">
			    <select name="sourceType" id="sourceType" class="form-control inteEdit">
					<option value="1" <#if interface?exists &&interface.sourceType== '1'>selected</#if>>默认数据源</option>
					<option value="2" <#if interface?exists &&interface.sourceType== '2'>selected</#if>>配置数据源</option>
			    </select>
			</div>
		</div>
		<div class="form-group layerServerSee" style="display:none">   
