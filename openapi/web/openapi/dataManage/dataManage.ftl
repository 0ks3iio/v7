            ...
            $(function(){
              //打开收起一级
                ...
                $('.main-content-inner').on('click','.baseData-inner-wrap .baseData-inner-header',function(){
                    ...
                    if('yes'!=$(this).data('mark')){
                      var data={'type':$(this).parent().data('resulttype'),'applyStatus':$parent.data('status') ,'uri':$(this).data('uri')};
                  ...
                  if(level==1){
                    if(msg.success){
                      ...
                      for(var i in objs){
                        ...
                        o.uri+'"><span class="description-wrap"><i class="fa fa-caret-down"></i><span class="description">'+
