	                                ...
	                                <div class="row">
	                                    <div class="col-xs-9">
	                                        ...
	                                        <div class="base-item" id="loginInterface" style="padding-top: 50px;">
	                                            <h3 class="base-menu-from" data-tier="2">接口一</h3>
	                                            ...
	                                            <table class="table " style="table-layout:fixed">
	                                                ...
	                                                <tr>
	                                                    ...
	                                                    <td >
	                                                        <p
	                                                            id="indexUrlOfLogin">http://www.demo.net/index.aspx</p>
	                                                    </td>
	                                                ...
	                                                <tr>
	                                                    ...
	                                                    <td >接口校验串（小写）context为空： auth=md5(appKey+appId+url+root)   context不为空 :auth=md5(appKey+appId+url+context+root)</td>
	                                                </tr>
	                                                <tr>
	                                                    <th class="table-title">接口样例</th>
	                                                    <td colspan="3" class="newline" id="urlOfLogin" >
	                                                        <p style="color:red;
	">${verifyUrl}?server=12345&url=http://www.demo.net/index.aspx&root=1&auth=708b13374b838d17222e51bbf6c86446</p>注：如果url有中文、特殊字符，需要urlEcode
	                                                    </td>
	                                                </tr>
	                                                </tbody>
	                                            </table>
	                                            <h3 class="base-menu-from" data-tier="2">接口二</h3>
	                                            <ul class="base-li-group">
	                                            ...
	                                            <table class="table " style="table-layout:fixed">
	                                                ...
	                                                <tr>
	                                                    <th class="table-title">接口地址</th>
	                                                    <td colspan="3">
		                                                    <p id="verifyUrl" style="color:red;">http://www.demo.net/verify.aspx</p>
	                                                                                                                                                                （域名+登录URL）
	                                                    </td>
	                                                </tr>
	                                                <tr>
	                                                ...
	                                                <tr>
	                                                    <td>url</td>
	                                                    <td id="indexUrlOfVerify">http://www.demo.net/index.aspx
	                                                    </td>
	                                                    <td>同接口一参数url</td>
	                                                </tr>
	                                                <tr>
	                                                    <td>auth</td>
	                                                    <td >密文:<p
	                                                            id="verifyEncodeAuth">3f185650731b63dc68244aab14ce05f2</p>明文:<p class="newline" id="verifyDecodeAuth">8A5F449F5A8A3716015AAC13B7EE4041http://www.demo.net/index.aspx000000X1J9BHLLBCA4QQL5F1UP6SACS1E2K32Y</p>
	                                                    </td>
	                                                ...
	                                                <tr>
	                                                    ...
	                                                    <td id="urlOfVerify" colspan="3" class="newline" >
	                                                        <p style="color: red">http://www.demo.net/verify.aspx?ticket=8A5F449F5A8A3716015AAC13B7EE4041&url=http://www.demo.net/index.aspx&auth=3f185650731b63dc68244aab14ce05f2 </p>  注：如果url有中文、特殊字符，需要urlEcode
	                                                    </td>
	                                                </tr>
	                                                </tbody>
	                                            </table>
	                                            <h3 class="base-menu-from" data-tier="2">接口三</h3>
	                                            <ul class="base-li-group">
	                                        ...
	                                        <div class="base-item" id="exitInterface" style="padding-top: 50px;">
	                                            ...
	                                            <table class="table " style="table-layout:fixed">
	                                                ...
	                                                <td>接口校验串（小写）auth=md5(ticket+appId+appKey)</td>
	                                                </tr>
	                                                <tr>
	                                                    <th class="table-title">接口样例</th>
    ...
    function changeServerOfLogin(server){
        $.ajax({
            ...
            success: function (result) {
                ...
                $("#indexUrlOfLogin").html(data.indexUrlOfLogin);
                //得到该应用的登陆地址
                $("#verifyUrl").html(data.verifyUrl);
                //得到应用的首页地址
                $("#indexUrlOfVerify").html(data.indexUrlOfLogin);
