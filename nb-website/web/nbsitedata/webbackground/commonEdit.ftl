...
<script>
	...
	$('.page-content-area').ace_ajax('loadScripts', [], function() {
		$("#btn-edit-cancel").on("click",function(){
			location.href="#${request.contextPath}/sitedata/${type!}/index/page?container=${container!}";
		});
		...
		<#if manager && webArticle.commitState?default('')=='1'>
            ...
            var type=a.options[a.selectedIndex].value;　    -->                      
                ...
                saveOrUpdate($(this),state,'','',pushType,'1');
