...
<div class="col-lg-12 common-list">
    <table id="simple-table" class="table  table-bordered table-hover">
        <thead>
        <tr>
        <#if (commitState?default('-1')=='1' || commitState?default('')=='0')&& container?default('')!='b'  >
        ...
        <#if dtos?exists && dtos?size gt 0>
            ...
            <tr>
                ...
                <td class="hidden-480">
                   ...
                   ${mcodeSetting.getMcode('DM-WZWZLX','${dto.webArticle.type!}')}
                ...
                <#if type?default('')!='11'>
                    ...
                    <#else>
                        ...
                        <#else >
                            <select id="cancle_${dto.webArticle.id!}" nullable="false" data-placeholder="请选择" class="form-control col-md-12 col-sm-12 col-xs-12 topSelect" <#if dto.webArticle.commitState?default('')=='4'||dto.webArticle.commitState?default('')=='5'> disabled="disabled"<#else>onChange="${container!}btnDelete('${container?default("b")}','${dto.webArticle.id!}','soflt');"</#if>>
                                <#if dto.webArticle.commitState?default('')=='4'||dto.webArticle.commitState?default('')=='5'>
                ...
                <#--<@d.btnList value="" type="" class="" title="编辑"/>-->
                    ...
                    <#if container?default('')=='b'>
                        <#if dto.webArticle.commitState?default('')!='4'&&dto.webArticle.commitState?default('')!='5'&&manager>
